            ...
            for (entity in mc.theWorld.getEntities(EntityArmorStand::class.java, EntitySelectors.selectAnything)) {
                try {
                    ...
                    if (matchSkullTexture(entity, pestPage.BEETLE_TEXTURE) && pestPage.beetleESP)
                        ...
                        render = true
                    else if (matchSkullTexture(entity, pestPage.FIELD_MOUSE_TEXTURE) && pestPage.fieldMouseESP)
                        render = true
                    else if (matchSkullTexture(entity, pestPage.FIREFLY_TEXTURE) && pestPage.fireflyESP)
                        render = true
                    else if (matchSkullTexture(entity, pestPage.DRAGONFLY_TEXTURE) && pestPage.dragonflyESP)
                        render = true
                    else if (matchSkullTexture(entity, pestPage.PRAYING_MANTIS_TEXTURE) && pestPage.prayingMantisESP)
                        render = true
...
class PestPage {
    @Switch(name = "Field Mouse ESP", size = 1)
    var fieldMouseESP: Boolean = true
    ...
    @Switch(name = "Firefly ESP", size = 1)
    var fireflyESP: Boolean = true

    @Switch(name = "Dragonfly ESP", size = 1)
    var dragonflyESP: Boolean = true

    @Switch(name = "Praying Mantis ESP", size = 1)
    var prayingMantisESP: Boolean = true

    @Exclude
    val FIELD_MOUSE_TEXTURE = ""
    @Exclude
    ...
    @Exclude
    val FIREFLY_TEXTURE = ""
    @Exclude
    val DRAGONFLY_TEXTURE = ""
    @Exclude
    val PRAYING_MANTIS_TEXTURE = ""
}